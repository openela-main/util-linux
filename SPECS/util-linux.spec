...
# -p -e rc1
Release: %autorelease
License: GPL-1.0-or-later AND GPL-2.0-only AND GPL-2.0-or-later AND GPL-3.0-or-later AND LGPL-2.1-or-later AND EUPL-1.2 AND BSD-2-Clause AND BSD-3-Clause AND BSD-4-Clause-UC AND LicenseRef-Fedora-Public-Domain
...
* Tue Jul 29 2025 Karel Zak <kzak@redhat.com> - 2.40.2-12
- coresched: backport new tool to RHEL-10

* Sat Apr 19 2025 Frank Liang <xiliang@redhat.com> - 2.40.2-11
...
* Mon Jun 24 2024 Troy Dawson <tdawson@redhat.com> - 2.40.1-5
- Bump release for June 2024 mass rebuild

* Wed Jun 05 2024 Karel Zak <kzak@redhat.com> - 2.40.1-4
- add others specfile requirements

* Tue Jun 04 2024 Karel Zak <kzak@redhat.com> - 2.40.1-3
- fix specfile requirements

* Tue May 28 2024 Karel Zak <kzak@redhat.com> - 2.40.1-2
- port gating.yaml file from rhel-9 to rhel-10

* Mon May 06 2024 Karel Zak <kzak@redhat.com> - 2.40.1-1
- upgrade to stable v2.40.1

* Thu Apr 18 2024 Karel Zak <kzak@redhat.com> - 2.40-12
- upgrade to v2.40

* Wed Feb 28 2024 Karel Zak <kzak@redhat.com> - 2.40-0.11.rc1
- fix license related stuff

* Wed Feb 28 2024 Karel Zak <kzak@redhat.com> - 2.40-0.10.rc1
- use SPDX based identifiers for license field

* Fri Feb 16 2024 Colin Walters <walters@verbum.org> - 2.40-0.9.rc1
